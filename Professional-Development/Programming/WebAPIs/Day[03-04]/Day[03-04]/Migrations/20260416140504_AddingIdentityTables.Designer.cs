...
namespace Day01.Migrations
{
    ...
    [Migration("20260416140504_AddingIdentityTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Day01.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Day01.Models.InsCourse", b =>
                {
            ...
            modelBuilder.Entity("Day01.Models.Instructor", b =>
                {
                    b.Property<int>("InsId")
                        .HasColumnType("int")
                        .HasColumnName("Ins_Id");
            ...
            modelBuilder.Entity("Day01.Models.StudCourse", b =>
                {
                    b.Property<int>("CrsId")
                        .HasColumnType("int")
                        .HasColumnName("Crs_Id");
            ...
            modelBuilder.Entity("Day01.Models.Topic", b =>
                {
                    b.Property<int>("TopId")
                        .HasColumnType("int")
                        .HasColumnName("Top_Id");
            ...
            modelBuilder.Entity("Day01.Models.Course", b =>
                {
                    b.HasOne("Day01.Models.Topic", "Top")
                        .WithMany("Courses")
                        .HasForeignKey("TopId")
            ...
            modelBuilder.Entity("Day01.Models.Department", b =>
                {
                    b.HasOne("Day01.Models.Instructor", "DeptManagerNavigation")
            ...
            modelBuilder.Entity("Day01.Models.InsCourse", b =>
                {
                    b.HasOne("Day01.Models.Course", "Crs")
                        .WithMany("InsCourses")
                        .HasForeignKey("CrsId")
                        .IsRequired()
                        .HasConstraintName("FK_Ins_Course_Course");

                    b.HasOne("Day01.Models.Instructor", "Ins")
                        .WithMany("InsCourses")
                        .HasForeignKey("InsId")
                        .IsRequired()
            ...
            modelBuilder.Entity("Day01.Models.Instructor", b =>
                {
                    b.HasOne("Day01.Models.Department", "Dept")
            ...
            modelBuilder.Entity("Day01.Models.StudCourse", b =>
                {
                    ...
                    b.HasOne("Day01.Models.Student", "St")
                        .WithMany("StudCourses")
                        .HasForeignKey("StId")
                        .IsRequired()
            ...
            modelBuilder.Entity("Day01.Models.Student", b =>
                {
                    ...
                    b.HasOne("Day01.Models.Student", "StSuperNavigation")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Day01.Models.ApplicationUser", null)
                        .WithMany()
